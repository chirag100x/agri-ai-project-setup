...
export const getSoilData = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { lat, lon } = req.query
...
export const getSatelliteData = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getCropRecommendations = async (req: Request, res: Response, next: NextFunction) => {
  try {
